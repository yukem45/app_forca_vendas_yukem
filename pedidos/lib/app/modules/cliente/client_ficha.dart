...
import 'package:pedidos/app/datamodule/dmlocal.dart';
import 'package:pedidos/app/modules/shared/format.dart';
import 'package:pedidos/app/modules/shared/icon_header.dart';
import 'package:http/http.dart' as http;
import 'package:pedidos/app/modules/shared/show_message.dart';

class ClienteFicha extends StatefulWidget {
  @override
  _ClienteFichaState createState() => _ClienteFichaState();
}

class _ClienteFichaState extends ModularState<ClienteFicha, AppController> {
              ...
              Center(
                child: RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    //gravar
                    if (Basedados.instance.id == '') {
                      await Basedados.instance.addCliente(Cliente(
                      ...
                      await Basedados.instance.updCliente(Cliente(
                        id: Basedados.instance.id,
                        nome: _nome.text,
                        cnpj: _cpfcnpj.text,
                        bairro: _bairro.text ?? '',
                        cep: _cep.text ?? '00.000-00',
