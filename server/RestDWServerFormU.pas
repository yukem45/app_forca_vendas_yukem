...
Uses LCL, LCLIntf, LCLType, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  ...
  ServerMethodsUnit1, ComCtrls, MaskEdit, StdCtrls, ExtCtrls, Menus, Buttons,
...
begin
  ...
  begin
    edPasta.Text := ExtractFilePath(OpenDialog1.FileName);
    edBD.Text := ExtractFileName(OpenDialog1.FileName);
  end;
end;
