...
procedure TServerMethodDM.DWServerEvents1EventsGravarReplyEvent(var Params: TDWParams;
  var Result: string);
var
  lQry: TZQuery;
...
procedure TServerMethodDM.DWServerEvents1EventsLoginReplyEvent(var Params: TDWParams;
  var Result: string);
...
procedure TServerMethodDM.DWServerEvents1EventsStatusReplyEvent(var Params: TDWParams;
  var Result: string);
begin
